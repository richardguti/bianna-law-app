...
The interstate agreement on qualifications of educational personnel is hereby enacted into law and entered into with all jurisdictions legally joining therein, in form substantially as follows:
ARTICLE I
...
2.  Any party state may withdraw from this agreement byM֯b_` class="Text Indent Justify">(1)  Nothing herein shall prevent or inhibit the enforcement of any other law of a member state that is not inconsistent with this compact.
(2)  Any laws, statutes, regulations, or other legal requirements in a member state in conflict with this compact are superseded to the extent of the conflict.

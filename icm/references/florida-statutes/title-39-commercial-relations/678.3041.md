...
(6)  
Unless otherwise agreed, a person making an indorsement assumes only the obligations provided in s. 678.1081 and not an obligation that the security will be honored by the issuer.

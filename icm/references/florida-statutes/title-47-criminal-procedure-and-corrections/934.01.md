...
(4)  
To safeguard the privacy of innocent persons, the interception of wire or oral communications when none of the parties to the communication has consented to the interception should be allowed only when authorized by a court of competent jurisdiction and should remain under the control and supervision of the authorizing court. Interception of wire and oral communications should further be limited to certain major }dexItem">934.42Mobile tracking device authorization.

934.425Installation or use of tracking devices or tracking applications; exceptions; penalties.

934.43Criminal disclosure of subpoena, order, or authorization.

934.50Searches and seizure using a drone.

934.51Possession, use, and sale of signal jamming device; prohibition; exceptions; penalties.
